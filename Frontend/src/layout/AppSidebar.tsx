...
import { FaRobot, FaPodcast } from "react-icons/fa";
import { IoDocumentTextOutline, IoFileTrayFull } from "react-icons/io5";
...
const AppSidebar: React.FC = () => {
  ...
  const othersItems: NavItem[] = [
    ...
    },
    {
      icon: <IoFileTrayFull />,
      name: "Flashcards",
      path: id ? `/notes/${id}/flashcards` : `/notes`,
    },
  ];
