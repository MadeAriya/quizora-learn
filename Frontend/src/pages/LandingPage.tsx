...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] font-sans selection:bg-purple-200 selection:text-indigo-900">
            {/* Navigation */}
            <nav className="fixed w-full top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-2xl tracking-tight text-gray-900">Quizora <span className="text-indigo-600">Learn</span></span>
                    </div>
                    <div>
                        {currentUser ? (
                            ...
                            <div className="flex items-center gap-4">
                                <Link to="/signin" className="text-gray-600 font-medium hover:text-indigo-600 transition-colors">Sign In</Link>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-gray-900 font-semibold text-lg hover:bg-gray-50 border border-gray-200 transition-all flex items-center justify-center gap-2 shadow-sm">
                                <FaPlayCircle className="text-indigo-600" size={20} /> Watch Demo
                            </button>
                        </div>
                        <p className="mt-4 text-sm text-gray-500 font-medium">No credit card required • 100% Free to start</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 border-y border-gray-100 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <p className="text-sm font-semibold tracking-wider text-gray-400 uppercase mb-8">Trusted by students from</p>
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                        <div className="text-2xl font-black font-serif text-gray-800 tracking-tighter">Stanford</div>
                        <div className="text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-1"><FaGraduationCap/> HARVARD</div>
                        <div className="text-2xl font-bold font-mono text-gray-800">MIT</div>
                        <div className="text-2xl font-semibold italic text-gray-800">Coursera</div>
                        <div className="text-2xl font-black text-gray-800">Udemy</div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 relative bg-[#fafafa]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <p className="text-xl text-gray-600">Say goodbye to hours of making flashcards. Let the AI do the heavy lifting in three simple steps.</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8 relative">
                        {/* Connecting Line */}
                        <div className="hidden md:block absolute top-[45px] left-[10%] w-[80%] h-0.5 bg-gradient-to-r from-indigo-100 via-purple-100 to-indigo-100"></div>

                        {/* Step 1 */}
                        <div className="relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 z-10 text-center group hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-gray-600 leading-relaxed">Drag and drop any file—PDFs, YouTube links, or voice recordings. We handle any format.</p>
                        </div>
                        ...
                        <div className="relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 z-10 text-center group hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-gray-600 leading-relaxed">Our AI extracts the core concepts, simplifies them, and builds your personalized study kit instantly.</p>
                        ...
                        <div className="relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 z-10 text-center group hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Ace It</h3>
                            <p className="text-gray-600 leading-relaxed">Practice with AI-generated quizzes, review smart flashcards, and track your progress to mastery.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-white relative">
                <div className="absolute left-0 top-0 w-full h-full bg-gradient-to-b from-indigo-50/50 to-white/50 pointer-events-none"></div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <span className="text-purple-600 font-bold tracking-wider uppercase text-sm">Features</span>
                        <h2 className="text-4xl font-extrabold text-gray-900 mt-2 mb-6">Everything you need to learn faster.</h2>
                    </div>

                    <div className="grid md:grid-cols-2 gap-6">
                        {/* Feature 1 */}
                        <div className="bg-white p-10 rounded-[2rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow">
                            <div className="w-14 h-14 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 mb-6">
                                <FaBrain size={24} />
                            </div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Interactive Quizzes</h3>
                            <p className="text-gray-600 leading-relaxed text-lg">Gamified testing designed to help information stick. Challenge yourself with multiple-choice, true/false, and open-ended questions.</p>
                        </div>
                        ...
                        <div className="bg-white p-10 rounded-[2rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow">
                            ...
                            <p className="text-gray-600 leading-relaxed text-lg">Spaced-repetition flashcards generated automatically from your content. Review at the perfect time and never forget key terms.</p>
                        </div>
                        ...
                        <div className="bg-white p-10 rounded-[2rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Beginner-Friendly Summaries</h3>
                            <p className="text-gray-600 leading-relaxed text-lg">Complex topics broken down into "Explain Like I'm 5" (ELI5) snapshots. Instantly grasp difficult concepts without the headache.</p>
                        </div>
                        ...
                        <div className="bg-white p-10 rounded-[2rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">Multi-Format Support</h3>
                            <p className="text-gray-600 leading-relaxed text-lg">Whether it's a 2-hour YouTube lecture, a dense 50-page PDF, or scanned handwritten notes—Quizora understands it all.</p>
            ...
            <section className="py-24 bg-[#fafafa]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-4xl font-extrabold text-gray-900 mb-6">Loved by learners everywhere.</h2>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Persona 1 */}
                        <div className="bg-white p-8 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 relative pt-14 text-center sm:text-left">
                            ...
                            <p className="text-gray-700 leading-relaxed font-medium mb-6">"As a self-taught coder, navigating dense documentation was a nightmare. Quizora turns dry API docs into interactive quizzes. It saved me hours of anxiety."</p>
                            <div>
                                <p className="font-bold text-gray-900">John D.</p>
                                <p className="text-sm text-gray-500">Self-Taught Coder</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 relative pt-14 text-center sm:text-left">
                            ...
                            <p className="text-gray-700 leading-relaxed font-medium mb-6">"My AP History lectures were 2 hours long on YouTube. Quizora generated 50 flashcards and a perfect summary in 10 seconds. My grades skyrocketed."</p>
                            <div>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 relative pt-14 text-center sm:text-left">
                            ...
                            <p className="text-gray-700 leading-relaxed font-medium mb-6">"I read a lot of non-fiction books for personal growth. I upload chapter summaries into Quizora, and the quizzes ensure I actually remember what I read."</p>
                            <div>
                                <p className="font-bold text-gray-900">Robert J.</p>
                                <p className="text-sm text-gray-500">Lifelong Learner</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-extrabold text-gray-900">Why switch to Quizora?</h2>
                    </div>

                    <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 overflow-hidden">
                        <div className="grid grid-cols-3 bg-gray-50/80 border-b border-gray-100 p-6 font-bold text-gray-900 text-sm sm:text-lg text-center">
                            <div className="text-left flex items-center">Feature</div>
                            <div className="text-gray-500 flex items-center justify-center">Traditional Studying</div>
                            <div className="text-indigo-600 flex items-center justify-center gap-2"><BsStars className="hidden sm:block"/> Quizora Learn</div>
                        </div>
                        ...
                        <div className="divide-y divide-gray-100 text-sm sm:text-base">
                            {[
                                ...
                                <div key={idx} className="grid grid-cols-3 p-4 sm:p-6 items-center text-center hover:bg-gray-50/50 transition-colors">
                                    <div className="text-left font-semibold text-gray-900 pr-2">{row.title}</div>
                                    <div className="text-gray-500 px-2">{row.trad}</div>
                                    <div className="text-indigo-600 font-bold bg-indigo-50/50 py-2 rounded-lg px-2">{row.new}</div>
                                </div>
                            ))}
                        </div>
                    </div>
